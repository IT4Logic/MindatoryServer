...
//        mvc.perform(get(ApplicationControllerEntryPoints.AttributeTemplateDataTypes))
...
//        var contents =
//            mvc.perform(get(ApplicationControllerEntryPoints.AttributeTemplateDataTypes + "/" + textDataTypeUUID))
//                .andExpect(status().isOk)
